...
def __getattr__(name: str) -> object:
    """Load optional feature families only when their public exports are used."""

    if name in _ACTIVITY_EXPORTS:
        from elderly_monitoring.modules.mental_health.feature_extraction import activity
