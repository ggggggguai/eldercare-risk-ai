"""Train the V3.3.3 ActivitySleepJointExpert under the frozen nested split."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        result = train_activity_sleep_joint_expert(
            repository_root,
            config,
    ...
    except (ActivitySleepJointExpertError, OSError, ValueError, RuntimeError) as exc:
        print(f"MODEL-003 training failed: {exc}", file=sys.stderr)
        return 1
