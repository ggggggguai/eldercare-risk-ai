"""Build deterministic DATA-006 NHANES DPQ+SSQ V3.3.3 artifacts."""
...
from elderly_monitoring.datasets.adapters.nhanes_ssq import (
    DATASET_ID,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = build_nhanes_ssq_artifacts(
