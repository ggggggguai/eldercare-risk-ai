"""Train the V3.3.3 SleepExpert under the frozen nested split."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    except (SleepExpertError, OSError, ValueError, RuntimeError) as exc:
        print(f"MODEL-002 training failed: {exc}", file=sys.stderr)
        return 1
