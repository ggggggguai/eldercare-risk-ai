"""Train the V3.3.3 SocialContextExpert under the frozen nested split."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        result = train_social_context_expert(
            repository_root,
            config,
    ...
    except (SocialContextExpertError, OSError, ValueError, RuntimeError) as exc:
        print(f"MODEL-005 training failed: {exc}", file=sys.stderr)
        return 1
