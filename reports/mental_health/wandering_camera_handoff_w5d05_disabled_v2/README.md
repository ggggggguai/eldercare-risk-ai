...
Run ID: `w5d05-b01-b02-disabled-context-20260818-v2`
...
```bash
conda run -n eldercare-ai python scripts/wandering/run_camera_handoff_e2e.py --output-root tmp/wandering_camera_5d_runs/w5d05-b01-b02-disabled-context-20260818-v2-replay --run-id w5d05-b01-b02-disabled-context-20260818-v2-replay
```
