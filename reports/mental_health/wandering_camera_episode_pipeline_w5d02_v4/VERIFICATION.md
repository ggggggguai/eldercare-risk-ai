...
```json
{
  "automatic": {
    "B01": {
      ...
      "known_episode_match_pipeline_miss_count": 20,
      "known_episode_prediction_coverage_miss_count": 6,
      "known_episode_support": 58,
      "pipeline_miss_count": 19,
      "pipeline_miss_reasons": {
        "matched_proposal_not_prediction_ready": 1,
        "no_automatic_boundary_match": 19
      },
      "prediction_coverage_gate_satisfied": true,
      "ready_uncertain_prediction_coverage": 0.896551724137931,
      "ready_uncertain_prediction_overlap_count": 52,
      "shape_binary_eligible_support": 52
    },
    "B02": {
      "automatic_binary": {
        "accuracy": 1.0,
      ...
      "automatic_binary_population": "automatic_boundary_matches_prediction_ready",
      "known_episode_match_pipeline_miss_count": 2,
      "known_episode_prediction_coverage_miss_count": 2,
      ...
      "shape_binary_eligible_support": 20
    },
    "pooled": {
      "automatic_binary": {
      ...
      "automatic_binary_population": "automatic_boundary_matches_prediction_ready",
      "known_episode_match_pipeline_miss_count": 22,
      "known_episode_prediction_coverage_miss_count": 8,
      "known_episode_support": 78,
      "pipeline_miss_count": 21,
      "pipeline_miss_reasons": {
        "matched_proposal_not_prediction_ready": 1,
        "no_automatic_boundary_match": 21
      },
      "prediction_coverage_gate_satisfied": true,
      "ready_uncertain_prediction_coverage": 0.8974358974358975,
      "ready_uncertain_prediction_overlap_count": 70,
      "shape_binary_eligible_support": 72
    }
  },
  "binary_adjustment_decision": {
    "decision": "retain_fixed_primary_and_threshold",
    "model_retrained": false,
    "reason": "fresh oracle binary macro-F1=0.8756286266924564 with fixed threshold 0.5; automatic conditional binary macro-F1=0.9363825363825364 and 22 known-episode boundary/QC match misses. The evidence does not support a camera binary adjustment.",
    "threshold": 0.5
  },
  ...
  "run_summary": {
    ...
    "failure_counts": {
      "automatic_binary_pipeline_miss": 21,
      "automatic_known_episode_coverage_miss": 8,
      "automatic_known_episode_match_miss": 22,
      "oracle_binary_pipeline_miss": 5,
      "prediction_inference_error": 0,
      "prediction_unavailable": 34,
      "proposal_rejected_by_qc": 24
    },
    "finished_at": "2026-08-18T04:20:28.282761Z",
    "identity": {
    ...
    "output_counts": {
      ...
      "model_forward_invocations": 95,
      "model_invocation_skipped": 34,
      "proposal_proposed": 15,
      "proposal_rejected_by_qc": 24,
      "proposal_results": 129,
      "proposal_uncertain": 90,
      "ready": 14,
      "unavailable": 34,
      "uncertain": 81
    },
    ...
    "run_id": "w5d02-b01-b02-20260818-v4",
    ...
    "started_at": "2026-08-18T04:19:46.119534Z",
    "status": "uncertain"
  }
}
```
