...
4. 步骤 9+9a 独立检查点和 PyTorch `2.13.0+cu130` runtime fact source 均已形成；下一项按步骤 10 的既定 exact schema 先建立红测，再实现生产源码。前向契约和 runtime 重建仍不得称为识别效果。
